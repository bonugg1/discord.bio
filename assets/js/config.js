const BADGES = [
  ...
  {
    name: "Active Developer", // Message that appears when you hover over it
    image: "assets/badges/server_owner.svg", // Icon (in .svg) of the badge that is in the "assets/badges" you choose
  },
];
